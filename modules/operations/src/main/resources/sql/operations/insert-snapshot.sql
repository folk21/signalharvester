INSERT INTO operations.health_snapshots (
    ...
    health_score, policy_version, component_statuses, signal_values, anomaly_candidates,
    ...
    CAST(:anomalyCandidates AS jsonb), CAST(:recentChangeIds AS jsonb), :applicationVersion,
