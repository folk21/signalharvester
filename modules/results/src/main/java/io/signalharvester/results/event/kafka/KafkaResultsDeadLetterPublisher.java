...
/** Maps failed Results input records to the shared dead-letter Protobuf contract and publishes them to Kafka. */
@Singleton
public final class KafkaResultsDeadLetterPublisher implements ResultsDeadLetterPublisher {

    private static final int MAX_FAILURE_MESSAGE_CHARS = 1000;
    private static final String CONSUMER_NAME = "results";

    private final ResultsDeadLetterKafkaClient kafkaClient;
    private final ResultsKafkaReliabilityConfiguration configuration;
    private final String consumerGroup;

    public KafkaResultsDeadLetterPublisher(
            ResultsDeadLetterKafkaClient kafkaClient,
